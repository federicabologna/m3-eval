#!/usr/bin/env python3
"""
Experiment runner for CQA-Eval perturbation experiments.
...
Usage:
    python run_cqa_experiments.py --experiment baseline --model Qwen3-8B
    python run_cqa_experiments.py --experiment error_detection --model gpt-4o
    python run_cqa_experiments.py --experiment error_priming --model claude-opus-4-5-20251101
"""
...
def generate_data_only(args):
    ...
    # Setup paths
    paths = setup_paths(args.output_dir, dataset='cqa_eval')
...
Examples:
  ...
  python experiment_runner.py --experiment error_priming --model claude-opus-4-5-20251101
    ...
    # Dataset is fixed to cqa_eval for this pipeline
    # For MedInfo experiments, use run_medinfo_experiments.py
    ...
    # Add dataset attribute (fixed to cqa_eval for this pipeline)
    args.dataset = 'cqa_eval'
    ...
    if args.experiment == 'baseline':
        from experiments.baseline_cqa import run_baseline_experiment
